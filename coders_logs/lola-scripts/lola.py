...
class Robot:
  def __init__ (self):
    ...
    #self.socket.connect( ("127.0.0.1", 1412) )
    #self.socket = PrefixMessagePackSocket(self.socket)
  ...
  def read (self):
    ...
    return msgpack.unpackb(stream, raw=False)
  ...
  def send (self):
    ...
    # simulation
    #self.socket.send(self.commands)
...
if __name__ == "__main__" :
  ...
  #  robot.command( "Stiffness" , j , 0.00 )
